<template>
  <div class="products">
      <div class="container">
                    Ovdje bi se trebalo vidjeti sta je tko narucio
       
        <!--  
          <div class="product-test">


            <h3 class="d-inline-block">Lista Narudzbi</h3>
            <button @click="addNew" class="btn btn-primary float-right">Dodaj Narudzbe</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="editLabel">Uredi Proizvod</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <!-- product sidebar -->
                  <div class="col-md-4">
                    <h4 class="display-6">Detalji Proizvoda</h4>
                    <hr>
                    ...
                    <div class="form-group">
                      <label for="product_image">Slike Proizvoda</label>
            ...
            <div class="modal-footer">
              ...
              <button @click="addProduct()" type="button" class="btn btn-primary" v-if="modal == 'new'">Spremi Proizvod</button> 
